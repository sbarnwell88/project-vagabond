...
london = City.create(name: 'London', image: 'http://i.imgur.com/OQ01Mrp.png', description: "At one time London was the largest city in the world, though now it is exceeded by several megacities on different continents it remains a city that fascinates and attracts millions of visitors each year. And for good reason- London is one of those great cosmopolitan centers that offer the visitor not just an unparalleled choice of museums and monuments, but also an unforgettable experience and a change of scenery. London is London, and no other city in the world is like it.")
